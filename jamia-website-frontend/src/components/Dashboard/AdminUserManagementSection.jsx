...
export default function AdminUserManagementSection() {
  const users = [
    { id: 1, name: 'Students', count: adminDashboardData.dashboard.statistics.totalStudents, icon: '👥', color: 'bg-blue' },
    { id: 2, name: 'Teachers', count: adminDashboardData.dashboard.statistics.totalTeachers, icon: '👨‍🏫', color: 'bg-green' },
    { id: 3, name: 'Admins', count: 3, icon: '⚙️', color: 'bg-purple' },
  ];
        ...
        {users.map((userGroup) => (
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <span className="text-4xl">{userGroup.icon}</span>
              <div>
