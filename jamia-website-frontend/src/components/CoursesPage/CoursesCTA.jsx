    ...
    <section className="relative py-16 lg:py-20 bg-primary overflow-hidden">
      <div className="absolute inset-0 pointer-events-none opacity-[0.06]">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="courses-cta-pattern" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
              <polygon points="60,0 120,60 60,120 0,60" fill="none" stroke="#C9A84C" strokeWidth="0.5" />
              <polygon points="60,15 105,60 60,105 15,60" fill="none" stroke="#C9A84C" strokeWidth="0.3" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#courses-cta-pattern)" />
        </svg>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-4 text-base sm:text-lg text-gold-light/80 max-w-2xl mx-auto leading-relaxed">
          Choose from our range of courses and begin your journey of authentic Islamic education today.
        </p>
