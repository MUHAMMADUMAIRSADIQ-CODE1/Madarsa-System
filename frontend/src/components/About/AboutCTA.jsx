    ...
    <section className="relative py-16 lg:py-20 bg-primary overflow-hidden">
      <div className="absolute inset-0 pointer-events-none opacity-[0.06]">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="about-cta-pattern" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
        <h2 className="font-heading text-3xl sm:text-4xl lg:text-[clamp(2rem,3.2vw,3.5rem)] font-bold text-white leading-tight">
          Join Our <span className="text-gold">Islamic Academy</span> Today
        </h2>
        <p className="mt-4 text-base sm:text-lg text-gold-light/80 max-w-2xl mx-auto leading-relaxed">
          Become part of a global community of learners dedicated to authentic Islamic education.
