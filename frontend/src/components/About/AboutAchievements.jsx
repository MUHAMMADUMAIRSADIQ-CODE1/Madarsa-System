...
import { injectStatsStyles } from '../Stats/Stats';
...
function AchievementCard({ stat, index }) {
  ...
  return (
    ...
    >
      {/* Ocean wave background — same as homepage stats */}
      ...
      {/* Content — sits above wave, bobs gently */}
      <div
...
// Inject shared animation styles (idempotent — only adds once)
