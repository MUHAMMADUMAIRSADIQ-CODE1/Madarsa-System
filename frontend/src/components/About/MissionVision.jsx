      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 gap-5 lg:gap-6 max-w-5xl mx-auto">
          <ScrollReveal delay={100}>
            <div className="bg-white rounded-2xl border border-border-light p-8 lg:p-10 transition-all duration-500 hover:shadow-[0_8px_40px_rgba(11,79,48,0.1)] h-full">
