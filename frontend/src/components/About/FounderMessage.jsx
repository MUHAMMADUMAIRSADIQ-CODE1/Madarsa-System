  ...
  return (
    <section className="relative py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-accent-soft via-white to-accent-soft/60 rounded-3xl border border-border-light p-8 lg:p-12 shadow-[0_4px_30px_rgba(11,79,48,0.06)] animate-fade-in-up">
