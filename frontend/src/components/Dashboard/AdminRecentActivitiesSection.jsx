...
import { FiAward, FiUser, FiBook, FiSettings } from 'react-icons/fi';
...
export default function AdminRecentActivitiesSection() {
  ...
  const getActivityIcon = (type) => {
    const icons = {
      enrollment: <FiAward className="text-primary" size={32} />,
      teacher: <FiUser className="text-blue-500" size={32} />,
      course: <FiBook className="text-purple-500" size={32} />,
      system: <FiSettings className="text-orange-500" size={32} />,
    };
    return icons[type] || <FiUser className="text-gray-500" size={32} />;
  };
