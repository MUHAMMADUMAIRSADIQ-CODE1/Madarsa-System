          ...
          return (
            ...
            >
              ...
              <div className="h-48 bg-gradient-to-br from-yellow-50 via-yellow-100 to-orange-50 relative overflow-hidden">
                ...
                <div className="absolute top-6 left-6 text-yellow-400 text-3xl opacity-30"><FiStar size={32} /></div>
                <div className="absolute bottom-6 right-6 text-yellow-400 text-3xl opacity-30"><FiStar size={32} /></div>
