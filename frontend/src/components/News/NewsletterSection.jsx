  ...
  return (
    <section className="py-12 lg:py-16 bg-gradient-to-br from-primary via-primary-dark to-primary relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
        ...
        {/* Success Message */}
        {isSubscribed && (
          <div className="mt-4 px-6 py-3 bg-emerald-500/20 border border-emerald-400/50 rounded-xl text-emerald-200 text-sm font-medium animate-fade-in flex items-center justify-center gap-2">
